...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 25, 2024 lúc 10:37 AM
...
--
-- Cấu trúc bảng cho bảng `app_form_client`
--
...
--
-- Đang đổ dữ liệu cho bảng `app_form_client`
--
...
--
-- Cấu trúc bảng cho bảng `app_form_server`
--
...
--
-- Đang đổ dữ liệu cho bảng `app_form_server`
--
...
--
-- Cấu trúc bảng cho bảng `expenditure`
--
...
--
-- Đang đổ dữ liệu cho bảng `expenditure`
--
...
--
-- Cấu trúc bảng cho bảng `repair_form`
--
...
--
-- Đang đổ dữ liệu cho bảng `repair_form`
--
...
(6, '20230621100653.jpg', 'Trương Ngọc Đăng', b'0', 1, b'1', 'truongngocdang@gmail.com', '2021-03-27', 2, 'Bắc Ninh', 2, '0869370492', 1, 21, 0, 0, 0),
...
--
-- Chỉ mục cho bảng `app_form_client`
--
ALTER TABLE `app_form_client`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `app_form_server`
--
...
--
-- AUTO_INCREMENT cho bảng `app_form_client`
--
ALTER TABLE `app_form_client`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT cho bảng `app_form_server`
--
ALTER TABLE `app_form_server`
...
--
-- AUTO_INCREMENT cho bảng `expenditure`
--
ALTER TABLE `expenditure`
...
--
-- AUTO_INCREMENT cho bảng `repair_form`
--
ALTER TABLE `repair_form`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
